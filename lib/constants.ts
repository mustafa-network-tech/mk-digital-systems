...
export const CONTACT_EMAIL =
  process.env.NEXT_PUBLIC_CONTACT_EMAIL || "mkdigitalsystems@hotmail.com";

/**
 * Formspree form ID. Tanımlıysa form doğrudan Formspree'ye gönderilir (mkdigitalsystems@hotmail.com).
