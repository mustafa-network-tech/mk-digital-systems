...
const de: SiteContent = {
  ...
  hero: {
    label: "STUDIO FÜR SOFTWARE & DIGITALE PRODUKTE",
    title: "Ihr Unternehmen.",
    accent: "Besser verbunden.",
    description:
      "Von individueller Software und mobilen Apps bis zu Unternehmenssystemen und kreativen Web-Erlebnissen: Wir machen aus Ideen digitale Produkte für den Alltag.",
    primary: "Per WhatsApp schreiben",
    secondary: "Unsere Projekte entdecken",
    visual: "Produktübersicht: Bildschirme aus echten Produkten von MK Digital Systems",
    needsLabel: "Was möchten Sie erreichen?",
    needs: {
      "operations": "Meinen Arbeitsalltag erleichtern",
      "presence": "Online stärker auftreten",
      "idea": "Meine Idee umsetzen",
    },
    stage: {
      "prev": "Vorheriges Produkt",
    ...
    categories: {
      "saha-santiye": "System für Außendienst & Baustellen",
      "aura": "Mobile Tagebuch-App",
      "mavi-sarkilar": "Kreatives Web-Erlebnis",
      "mk-adisyon": "Restaurant- & Café-Management",
      "kadraj-rotam": "Plattform für Fotorouten",
      "musty": "Visuelles Premium-Web-Erlebnis",
      "mk-farm": "Software für die Hofverwaltung",
      "aria": "Oberfläche einer sozialen Plattform",
      "namehub": "Plattform für Namen & digitale Identität",
      "mavi-kadraj-otel": "Hotel-Website",
      "gonul-pusulasi": "Kreatives Web & digitale Inhalte",
      "mavi-kadraj-arsiv": "Fotoarchiv & Web-Erlebnis",
    },
    tags: {
      "selected": "Ausgewählte Arbeit",
