...
const en: SiteContent = {
  ...
  hero: {
    label: "SOFTWARE & DIGITAL PRODUCT STUDIO",
    title: "Your business.",
    accent: "Better connected.",
    description:
      "From custom software and mobile apps to business systems and creative web experiences, we turn ideas into digital products people use every day.",
    primary: "Message on WhatsApp",
    secondary: "Explore our work",
    visual: "Product showcase: screens from real products built by MK Digital Systems",
    needsLabel: "What would you like to do?",
    needs: {
      "operations": "Make my daily work easier",
      "presence": "Look stronger online",
      "idea": "Bring my idea to life",
    },
    stage: {
    ...
    categories: {
      "saha-santiye": "Field & site operations system",
      "aura": "Mobile journaling app",
      "mavi-sarkilar": "Creative web experience",
      "mk-adisyon": "Restaurant & café management",
      "kadraj-rotam": "Photo route platform",
      "musty": "Premium visual web experience",
      "mk-farm": "Farm management software",
